...
#include <ogdf/basic/graphics.h>         // for toString, Color
#include <ogdf/fileformats/GDF.h>        // for toString, NodeAttribute, EdgeAttribute
#include <ogdf/fileformats/GraphIO.h>    // for GraphIO
#include <ostream>                       // for basic_ostream, operator<<, basic_ostream::operat...
...
static inline void writeNodeHeader(std::ostream& os, const GraphAttributes* GA) {
	os << "nodedef>";
...
static inline void writeNode(std::ostream& os, const GraphAttributes* GA, node v) {
	/*
...
static inline void writeEdgeHeader(std::ostream& os, const GraphAttributes* GA) {
	os << "edgedef>";
	...
	if (attrs & (GraphAttributes::edgeIntWeight | GraphAttributes::edgeDoubleWeight)) {
...
static inline void writeEdge(std::ostream& os, const GraphAttributes* GA, edge e) {
	os << "n" << e->source()->index() << ","
	   << "n" << e->target()->index();
	if (GA && GA->directed()) {
		os << ","
...
static void writeGraph(std::ostream& os, const Graph& G, const GraphAttributes* GA) {
