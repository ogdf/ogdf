...
EdgeStandardRep::EdgeStandardRep(const Hypergraph &pH, 
                                 EdgeStandardType::Type pType = 
                                 EdgeStandardType::star)  :
...
void EdgeStandardRep::hyperedgeToClique(hyperedge e)
{
    ...
    edge eRep;
    for (adjHypergraphEntry adjSrc = e->firstAdj(); adjSrc->succ();
         adjSrc = adjSrc->succ()) 
        for (adjHypergraphEntry adjTgt = adjSrc->succ(); adjTgt;
             adjTgt = adjTgt->succ()) {
