...
ListIterator<HypergraphObserver *> Hypergraph::registerObserver
(HypergraphObserver *pObserver) const
{
    return m_observers.pushBack(pObserver);
}

void Hypergraph::unregisterHypernodeArray 
(ListIterator<HypergraphArrayBase *> it) const
{
    m_hypernodeArrays.del(it);
}

void Hypergraph::unregisterHyperedgeArray
(ListIterator<HypergraphArrayBase *> it) const
{
    m_hyperedgeArrays.del(it);
}

void Hypergraph::unregisterObserver
