...
namespace ogdf::energybased::fmmm { class ParticleInfo; }
...
QuadTreeNM::QuadTreeNM() { root_ptr = act_ptr = nullptr; }

void QuadTreeNM::create_new_lt_child(List<ParticleInfo>* L_x_ptr, List<ParticleInfo>* L_y_ptr) {
...
void QuadTreeNM::create_new_rt_child(List<ParticleInfo>* L_x_ptr, List<ParticleInfo>* L_y_ptr) {
	QuadTreeNodeNM* new_ptr = new QuadTreeNodeNM();
...
void QuadTreeNM::create_new_lb_child(List<ParticleInfo>* L_x_ptr, List<ParticleInfo>* L_y_ptr) {
	QuadTreeNodeNM* new_ptr = new QuadTreeNodeNM();
...
void QuadTreeNM::create_new_rb_child(List<ParticleInfo>* L_x_ptr, List<ParticleInfo>* L_y_ptr) {
	QuadTreeNodeNM* new_ptr = new QuadTreeNodeNM();
