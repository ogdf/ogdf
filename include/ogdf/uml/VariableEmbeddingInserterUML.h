...
/**
 * The class VariableEmbeddingInserterUML represents the optimal edge insertion
 ...
 */
class OGDF_EXPORT VariableEmbeddingInserterUML : public UMLEdgeInsertionModule {
public:
...
private:
	...
	virtual ReturnType doCall(PlanRepLight& pr, const Array<edge>& origEdges,
			const EdgeArray<int>* pCostOrig, const EdgeArray<uint32_t>* pEdgeSubgraph) override;
