...
#ifndef OGDF_DTREE_WSPD_H_
#define OGDF_DTREE_WSPD_H_

#include <ogdf/basic/basic.h>
#include <ogdf/internal/energybased/DTree.h>
...
public:
    ...
    typedef DTree<IntType, Dim> Tree;
    ...
    // returs the parameter s of the WSPD (default is 1.0)
