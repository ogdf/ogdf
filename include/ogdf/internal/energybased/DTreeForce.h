...
public:
    ...
    friend class DTreeWSDPCallback;

    typedef DTreeWSPD<Dim> WSPD;
    typedef typename WSPD::Tree Tree;
...
private:
    ...
    struct NodeData
    {
        ...
        // th first deriv of the distance based force function
        double force_prime;
    };
...
template<int Dim, typename ForceFunc, bool UseForcePrime>
class DTreeWSDPCallback : public IWSPD
{
public:
    DTreeWSDPCallback(DTreeForce<Dim>& treeForce, ForceFunc forceFunc)
...
void DTreeForce<Dim>::computeForces(ForceFunc forceFunc)
{
    ...
    DTreeWSDPCallback<Dim, ForceFunc, UseForcePrime> wspdCallBack(*this, forceFunc);
