...
public:
	...
	//! too.
	void pack_rectangles_using_Best_Fit_strategy(List<Rectangle>& R, double aspect_ratio,
...
private:
	...
	void B_F_insert_rectangle_in_new_row(Rectangle r, List<PackingRowInfo>& P,
	...
	//! the drawing.
	ListIterator<PackingRowInfo> find_Best_Fit_insert_position(ListIterator<Rectangle> rect_item,
			FMMMOptions::TipOver allow_tipping_over, double aspect_ratio, double& aspect_ratio_area,
			PQueue& total_width_of_row);


	//! Inserts r into the row with corresponding ListIterator B_F_item and updates
	//! total_width_of_row.
	void B_F_insert_rectangle(Rectangle r, List<PackingRowInfo>& P,
			List<ListIterator<PackingRowInfo>>& row_of_rectangle,
			ListIterator<PackingRowInfo> B_F_item, PQueue& total_width_of_row);
	...
	void export_new_rectangle_positions(List<PackingRowInfo>& P,
			List<ListIterator<PackingRowInfo>>& row_of_rectangle,
