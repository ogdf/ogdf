 ...
 */
template<class E>
class QueuePure : private SListPure<E> {
public:
	...
	const_reference top() const { return SListPure<E>::front(); }

	//! Returns a reference to the front element.
	reference top() { return SListPure<E>::front(); }

	//! Returns a reference to the back element.
	const_reference bottom() const { return SListPure<E>::back(); }

	//! Returns a reference to the back element.
	reference bottom() { return SListPure<E>::back(); }
	...
	iterator append(const E& x) { return SListPure<E>::pushBack(x); }
...
public:
	...
	//! Returns a reference to the front element.
	const_reference top() const { return SList<E>::front(); }

	//! Returns a reference to the front element.
	reference top() { return SList<E>::front(); }
	...
	//! Adds \p x at the end of queue.
	iterator append(const E& x) { return SList<E>::pushBack(x); }
