...
public:
	...
	HashConstIterator2D(
			const HashConstIterator<Tuple2<I1_, I2_>, E_, HashFuncTuple<I1_, I2_, Hash1_, Hash2_>>& it)
		: HashConstIterator<Tuple2<I1_, I2_>, E_, HashFuncTuple<I1_, I2_, Hash1_, Hash2_>>(it) { }

	//! Assignemnt operator.
	HashConstIterator2D<I1_, I2_, E_, Hash1_, Hash2_>& operator=(
			const HashConstIterator2D<I1_, I2_, E_, Hash1_, Hash2_>& it) {
	...
	const I1_& key1() const {
		return HashConstIterator<Tuple2<I1_, I2_>, E_, HashFuncTuple<I1_, I2_, Hash1_, Hash2_>>::key()
				.x1();
	}
