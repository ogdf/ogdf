...
public:
	VarEdgeInserterDynCore(PlanRepLight& pr, const EdgeArray<int>* pCostOrig,
...
protected:
	...
	virtual void buildSubpath(node v, node vPred, node vSucc, List<adjEntry>& L, ExpandedGraph& Exp,
			node s, node t);
...
public:
	VarEdgeInserterDynUMLCore(PlanRepLight& pr, const EdgeArray<int>* pCostOrig,
			const EdgeArray<uint32_t>* pEdgeSubgraph)
		: VarEdgeInserterDynCore(pr, pCostOrig, nullptr, pEdgeSubgraph) { }
