...
public:
  ...
  */
  //@{
	...
	virtual bool setIntParam(OsiIntParam key, int value) override;
	...
	virtual bool setDblParam(OsiDblParam key, double value) override;
	...
	virtual bool setStrParam(OsiStrParam key, const std::string & value) override;
	...
	virtual bool getIntParam(OsiIntParam key, int& value) const override;
	...
	virtual bool getDblParam(OsiDblParam key, double& value) const override;
	...
	virtual bool getStrParam(OsiStrParam key, std::string& value) const override;
   ...
   */
   ...
   virtual bool isContinuous(int colIndex) const override;
  ...
  //@{
   ...
   virtual int readMps(const char * infile, const char *extension = "mps") override;

   virtual int readGMPL(const char * modelFile, const char * dataFile=nullptr) override;
